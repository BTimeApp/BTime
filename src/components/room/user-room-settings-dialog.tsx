  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        ...
        <div>
            <p>Inspection</p>
            <Switch defaultChecked={useInspection} checked={useInspection} onCheckedChange={setUseInspection}/>
        </div>
        <div>
            <p>Timer Type</p>
            <Select onValueChange={setTimerType}>
            <SelectTrigger>
                <SelectValue placeholder={timerType.at(0) + timerType.slice(1).toLowerCase()} />
            </SelectTrigger>
            <SelectContent>
        ...
        <div>
            <p>Toggle Theme</p>
            <ToggleGroup onValueChange={setTheme} type="single" defaultValue={resolvedTheme}>
